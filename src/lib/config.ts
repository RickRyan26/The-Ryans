...
export const config = {
	...
	debra: {
		...
		ig: `debrakaygeorgeinteriors`,
		igLink: `https://www.instagram.com/debrakaygeorgeinteriors/`,
		quote: {
			title: `The Designer`,
