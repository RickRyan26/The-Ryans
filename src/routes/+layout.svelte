...
<div
	...
	class:dark:!from-slate-400={$page.data.src === 'debra'}
	class:dark:!to-slate-800={$page.data.src === 'debra'}
	class="bg-gradient-to-br from-purple-200 to-purple-500 transition-all dark:from-purple-400 dark:to-purple-900"
>
	<SiteHeader />
